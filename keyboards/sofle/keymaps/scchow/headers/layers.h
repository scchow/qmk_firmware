 ...
 */
  ...
  //|------+-------+--------+--------+--------+------|  ===  |  |  ===  |--------+-------+----------+--------+--------+---------|
    KC_LALT, KC_LGUI, TT(_NAV), MT(MOD_LCTL,KC_SPC),TD(TD_LALT_LCTL),  KC_BSPC, KC_SPC, KC_ENT,  TT(_NAV), TG(_GAME)
  //            \--------+--------+--------+---------+-------|  |-------+--------+--------+---------+-------/
),
...
[_NAV2] = LAYOUT(
 ...
 LALT(KC_F4),     KC_F1,      KC_F2,      KC_F3,   KC_F4,   KC_F5,                     KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_DEL,
  //-------+-----------+-----------+-----------+--------+--------|                    |--------+-------+--------+--------+--------+---------|
 LCA(KC_DEL),     KC_NO,    KC_PGUP,      KC_NO,   KC_NO,   KC_NO,                   LCTL(KC_Y), KC_MINS,  KC_EQL, KC_LBRC, KC_RBRC, KC_F11,
  //|------+-----------+-----------+-----------+--------+--------|                    |--------+-------+--------+--------+--------+---------|
     _______,   KC_HOME,    KC_PGDN,    KC_END,   KC_NO,   KC_NO,                     KC_HOME, KC_PGDN, KC_PGUP, KC_END, KC_NO,   KC_F12,
  //|------+-----------+-----------+-----------+--------+--------|  ====  |   |  ===  |--------+-------+--------+--------+--------+---------|
...
[_CONFIG] = LAYOUT(
  ...
  //|--------+--------+---------+---------+---------+----------|   ===   |   |   ===   |----------+----------+----------+----------+----------+----------|
      KC_LSFT,   KC_NO,  RGB_HUI,  RGB_SAD,  RGB_VAD,     KC_NO,  QK_BOOT,      QK_BOOT,   _______,   _______,   _______,   _______,   _______,   KC_LSFT,
  //|--------+--------+---------+---------+---------+----------|   ===   |   |   ===   |----------+----------+----------+----------+----------+----------|
                             _______, _______, _______,  _______, _______,      _______,   _______, _______,  _______, _______
  //                       \--------+--------+--------+---------+--------|   |--------+----------+--------+---------+--------/
),
