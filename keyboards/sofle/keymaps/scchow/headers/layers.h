...
LALT(KC_F4),      KC_F1,      KC_F2,      KC_F3,      KC_F4,      KC_F5,                           KC_F6,      KC_F7,      KC_F8,      KC_F9,     KC_F10,  KC_DEL,
  //-------+-----------+-----------+-----------+-----------+-----------|                    |-----------+-----------+-----------+-----------+-----------+---------|
LCA(KC_DEL), LCTL(KC_Q), LCTL(KC_W), LCTL(KC_E), LCTL(KC_R), LCTL(KC_T),                         KC_LPRN,     KC_EQL,    KC_MINS,    KC_PLUS,    KC_UNDS,  KC_F11,
  //|------+-----------+-----------+-----------+-----------+-----------|                    |-----------+-----------+-----------+-----------+-----------+---------|
    _______, LCTL(KC_A), LCTL(KC_S), LCTL(KC_D), LCTL(KC_F), LCTL(KC_G),                         KC_LEFT,    KC_DOWN,      KC_UP,    KC_RGHT,    KC_COLN,  KC_F12,
  //|------+-----------+-----------+-----------+-----------+-----------|  ====  |   |  ===  |-----------+-----------+-----------+-----------+-----------+---------|
    _______, LCTL(KC_Z), LCTL(KC_X), LCTL(KC_C), LCTL(KC_V), LCTL(KC_S), _______,    _______,    KC_RPRN,    KC_LBRC,    KC_RBRC,    KC_LCBR,    KC_RCBR,  _______,
  //|------+-----------+-----------+-----------+-----------+-----------|  ====  |   |  ===  |-----------+-----------+-----------+-----------+-----------+---------|
...
LALT(KC_F4),      KC_F1,      KC_F2,      KC_F3,      KC_F4,      KC_F5,                           KC_F6,      KC_F7,      KC_F8,      KC_F9,     KC_F10,  KC_DEL,
  //-------+-----------+-----------+-----------+-----------+-----------|                    |-----------+-----------+-----------+-----------+-----------+---------|
LCA(KC_DEL), LCTL(KC_Q), LCTL(KC_W), LCTL(KC_E), LCTL(KC_R), LCTL(KC_T),                         KC_LPRN,    KC_PLUS,    KC_UNDS,     KC_EQL,    KC_MINS,   KC_F11,
  //|------+-----------+-----------+-----------+-----------+-----------|                    |-----------+-----------+-----------+-----------+-----------+---------|
    _______, LCTL(KC_A), LCTL(KC_S), LCTL(KC_D), LCTL(KC_F), LCTL(KC_G),                         KC_HOME,    KC_PGDN,    KC_PGUP,     KC_END,    KC_COLN,  KC_F12,
  //|------+-----------+-----------+-----------+-----------+-----------|  ====  |   |  ===  |-----------+-----------+-----------+-----------+-----------+---------|
    _______, LCTL(KC_Z), LCTL(KC_X), LCTL(KC_C), LCTL(KC_V), LCTL(KC_S), _______,    _______,    KC_RPRN,    KC_LBRC,    KC_RBRC,    KC_LCBR,    KC_RCBR,  _______,
  //|------+-----------+-----------+-----------+-----------+-----------|  ====  |   |  ===  |-----------+-----------+-----------+-----------+-----------+---------|
                                    _______, _______, _______,  _______, _______,     _______,  _______, _______,  _______, _______
...
LT(_GAME2,KC_ESC),  KC_A,     KC_S,     KC_D,     KC_F,      KC_G,                            KC_H,      KC_J,      KC_K,      KC_L,   KC_SCLN,   KC_QUOT,
    //|--------+--------+---------+---------+---------+----------|   ===  |   |  ===   |----------+----------+----------+----------+----------+----------|
        KC_LSFT,    KC_Z,     KC_X,     KC_C,      KC_V,     KC_B,TG(_GAME),   KC_D_MUTE,      KC_N,      KC_M,   KC_COMM,    KC_DOT,   KC_SLSH,    KC_ENT,
    //|--------+--------+---------+---------+---------+----------|   ===  |   |  ===   |----------+----------+----------+----------+----------+----------|
...
[_CONFIG] = LAYOUT(
  ...
  //|--------+--------+---------+---------+---------+----------|                      |----------+----------+----------+----------+----------+----------|
      RGB_MOD, RGB_M_K,  RGB_M_X,  RGB_M_G,  RGB_M_T,  RGB_M_TW,                          _______,   DT_UP,   _______,   _______,   _______,   _______,
  //|--------+--------+---------+---------+---------+----------|                      |----------+----------+----------+----------+----------+----------|
     RGB_RMOD,   KC_NO,  RGB_HUI,  RGB_SAI,  RGB_VAI,     KC_NO,                          _______,   DT_DOWN,   DT_PRNT,   _______,   _______,   _______,
  //|--------+--------+---------+---------+---------+----------|   ===   |   |   ===   |----------+----------+----------+----------+----------+----------|
