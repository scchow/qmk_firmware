 ...
 */
  ...
  //|------+-------+--------+--------+--------+------|  ===  |  |  ===  |--------+-------+----------+--------+--------+---------|
    KC_LALT, KC_LGUI, TT(_NAV), MT(MOD_LCTL,KC_SPC),TD(TD_LCTL_LALT),  KC_BSPC, KC_SPC, KC_ENT,  TT(_NAV), TG(_GAME)
  //            \--------+--------+--------+---------+-------|  |-------+--------+--------+---------+-------/
),
...
[_CONFIG] = LAYOUT(
  ...
  //|--------+--------+---------+---------+---------+----------|   ===   |   |   ===   |----------+----------+----------+----------+----------+----------|
                             EH_LEFT, EH_RGHT, _______,  _______, _______,      EE_CLR,   _______, _______,  EH_RGHT, EH_LEFT
  //                       \--------+--------+--------+---------+--------|   |--------+----------+--------+---------+--------/
),
};
