 ...
 */
  ...
  //|------+-------+--------+--------+--------+------|  ==  |  |  ===  |--------+-------+----------+--------+--------+---------|
   KC_LALT, TT(_NAV), KC_LGUI, LT(_NAV, KC_SPC), MT(MOD_LCTL, KC_BSPC), MT(MOD_LALT, KC_DEL),  LT(_NAV, KC_SPC),  MT(MOD_LSFT,KC_ENT),  TT(_NAV), TG(_GAME)
  //    \-------+--------+---------+-------+-----------------|  |-------+--------+--------+---------+-------/
),
...
[_NAV] = LAYOUT(
 ...
 LCA(KC_DEL),LCTL(KC_Q),   KC_NO,  KC_UP, LCTL(KC_R), LCTL(KC_T),                      LCTL(KC_Y), KC_MINS, KC_EQL,  KC_LBRC, KC_RBRC, KC_F11,
  ...
  //|------+-----------+-----------+-----------+--------+--------|  ====  |   |  ===  |--------+-------+--------+--------+--------+---------|
_______,LCTL(KC_Z), LCTL(KC_X), LCTL(KC_C), LCTL(KC_V), LCTL(KC_S), _______,  _______, _______, KC_LBRC, KC_RBRC, KC_LCBR, KC_RCBR, _______,
  //|------+-----------+-----------+-----------+--------+--------|  ====  |   |  ===  |--------+-------+--------+--------+--------+---------|
                               _______, _______, _______,  TG(_NAV), _______,   KC_DEL,  _______,   _______,    TG(_NAV), LALT(KC_F4)
  //                         \--------+--------+--------+---------+-------|   |--------+---------+--------+---------+-------/
),
