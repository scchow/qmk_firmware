 ...
 */
  ...
  //|------+-------+--------+--------+--------+------|  ===  |  |  ===  |--------+-------+----------+--------+--------+---------|
                  KC_LALT, KC_LGUI, TT(_NAV),   KC_SPC,KC_LCTL,   KC_LALT, KC_SPC, KC_ENT, MO(4), TG(_GAME)
  //            \--------+--------+--------+---------+-------|  |-------+--------+--------+---------+-------/
),
...
[_NAV] = LAYOUT(
 ...
 LALT(KC_F4),     KC_F1,      KC_F2,      KC_F3,   KC_F4,   KC_F5,                     KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_DEL,
  //-------+-----------+-----------+-----------+--------+--------|                    |--------+-------+--------+--------+--------+---------|
 LCA(KC_DEL),     KC_NO,      KC_NO,      KC_NO,   KC_NO,   KC_NO,                  LCTL(KC_Y), KC_EQL,  KC_MINS, KC_LBRC, KC_RBRC, KC_F11,
  //|------+-----------+-----------+-----------+--------+--------|                    |--------+-------+--------+--------+--------+---------|
  ...
  //|------+-----------+-----------+-----------+--------+--------|  ====  |   |  ===  |--------+-------+--------+--------+--------+---------|
                 _______, _______, TG(_NAV), _______, _______,     _______, _______, _______, _______, _______
  //            \--------+--------+--------+---------+-------|   |--------+---------+--------+---------+-------/
),
...
[_NAV2] = LAYOUT(
 ...
 LALT(KC_F4),     KC_F1,      KC_F2,      KC_F3,   KC_F4,   KC_F5,                     KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_DEL,
  //-------+-----------+-----------+-----------+--------+--------|                    |--------+-------+--------+--------+--------+---------|
 LCA(KC_DEL),     KC_NO,      KC_UP,      KC_NO,   KC_NO,   KC_NO,                   LCTL(KC_Y), KC_PLUS, KC_UNDS, KC_LBRC, KC_RBRC, KC_F11,
  //|------+-----------+-----------+-----------+--------+--------|                    |--------+-------+--------+--------+--------+---------|
