 ...
 */
  ...
  //|------+-------+--------+--------+--------+------|  ===  |  |  ===  |--------+-------+----------+--------+--------+---------|
                  KC_LALT, KC_LGUI, KC_LCTL,   KC_SPC,TT(_NAV),   KC_LALT, KC_SPC, KC_ENT, MO(4), TG(_GAME)
  //            \--------+--------+--------+---------+-------|  |-------+--------+--------+---------+-------/
),
...
[_NAV] = LAYOUT(
 ...
 LCA(KC_DEL),     KC_NO,      KC_NO,      KC_NO,   KC_NO,   KC_NO,                  LCTL(KC_Y), KC_EQL,  KC_MINS, KC_LBRC, KC_RBRC, KC_F11,
  ...
  //|------+-----------+-----------+-----------+--------+--------|  ====  |   |  ===  |--------+-------+--------+--------+--------+---------|
                 _______, _______,  _______, _______, TG(_NAV),    _______, _______, _______, _______, _______
  //            \--------+--------+--------+---------+-------|   |--------+---------+--------+---------+-------/
),
