...
[_NAV2] = LAYOUT(
 ...
 LALT(KC_F4),     KC_F1,      KC_F2,      KC_F3,   KC_F4,   KC_F5,                     KC_F6,   KC_F7,   KC_F8,   KC_F9,  KC_F10,  KC_DEL,
  //-------+-----------+-----------+-----------+--------+--------|                    |--------+-------+--------+--------+--------+---------|
 LCA(KC_DEL),     KC_NO,      KC_UP,      KC_NO,   KC_NO,   KC_NO,                   LCTL(KC_Y), KC_MINS,  KC_EQL, KC_LBRC, KC_RBRC, KC_F11,
  //|------+-----------+-----------+-----------+--------+--------|                    |--------+-------+--------+--------+--------+---------|
...
[_CONFIG] = LAYOUT(
  //|--------+--------+---------+---------+---------+----------|                      |----------+----------+----------+----------+----------+----------|
      RGB_TOG, RGB_M_P,  RGB_M_B,  RGB_M_R, RGB_M_SW,  RGB_M_SN,                          _______,   _______,   _______,   _______,   _______,   RGB_TOG,
  //|--------+--------+---------+---------+---------+----------|                      |----------+----------+----------+----------+----------+----------|
  ...
  //|--------+--------+---------+---------+---------+----------|   ===   |   |   ===   |----------+----------+----------+----------+----------+----------|
      KC_LSFT, _______,  _______,  _______,  _______,   _______,  QK_BOOT,      QK_BOOT,   _______,   _______,   _______,   _______,   _______,   KC_LSFT,
  //|--------+--------+---------+---------+---------+----------|   ===   |   |   ===   |----------+----------+----------+----------+----------+----------|
                             _______, _______, _______,  _______, _______,      _______,   _______, _______,  _______, _______
  //                       \--------+--------+--------+---------+--------|   |--------+----------+--------+---------+--------/
),
